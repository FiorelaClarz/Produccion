        ...
        <div class="card-body">
            <form action="{{ route('produccion.guardar-personal') }}" method="POST" id="produccionForm">
                        ...
                        <tbody>
                                ...
                                <td class="text-center">
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="number"
                                            ...
                                            step="1.00" min="0"
                                            value="{{ old("costo_diseño.".$pedido->id_pedidos_det, $pedido->costo_diseño ?? 0.00) }}"
                                            {{ $esIniciado ? '' : 'disabled' }}
                            ...
                            <tr class="total-receta-agrupada bg-light" data-recid="{{ $idReceta }}">
                                ...
                                <td class="text-center">
                                    ...
                                    return $subtotal + ($p->costo_diseño ?? 0.00);
                                    });
                                    @endphp
                                ...
                                <td class="text-center" id="total-costo-diseno-{{ $idReceta }}">
                                    ...
                                    ->where('es_cancelado', false)
                                    ->first();
                                    return $produccionDet ? $produccionDet->costo_diseño : 0.00;
                                    });
                ...
                <div class="form-group mt-4 text-center">
                    @if($recetasAgrupadas && count($recetasAgrupadas) > 0 && $equipoActivo && $estadoActual === 'pendientes' && !($equipoActivo->salida))
            ...
            <div class="form-group mt-4 text-center">
                ...
                <script>
                    ...
                    // Definición de la función confirmarSalida en el mismo bloque para garantizar disponibilidad
...
<style>
    ...
    .production-item {
        ...
        /* Color base más fuerte para filas principales */
    ...
    .pedido-personalizado {
        ...
        /* Color base más suave para personalizados */
        transition: all 0.3s ease;
    }
...
<script>
    ...
    function validarTerminado(idReceta) {
        ...
        logAction('Validación para terminar exitosa', {
            receta_id: idReceta
        });
        return true;
    }
    ...
    function mostrarEstadoActual(idReceta) {
        try {
            ...
            logAction('Error al mostrar estado actual', {
                error: error.message
            });
        }
    }
    ...
    function mostrarEstadoActualPersonalizado(idPedido) {
        ...
        try {
            ...
            logAction('___________________Error al mostrar estado actual personalizado', {
                error: error.message
            });
        }
    }
    ...
    function mostrarDetallesPersonales(idReceta) {
        ...
        if (!recetaData) {
            logAction('No se encontraron datos para la receta', {
                receta_id: idReceta
            });
            return;
        }
        ...
        if (pedidosPersonalizados.length === 0) {
            logAction('No hay pedidos personalizados para esta receta', {
                receta_id: idReceta
            });
            return;
        }
